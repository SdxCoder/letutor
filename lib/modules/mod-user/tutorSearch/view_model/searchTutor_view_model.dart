...
class SearchTutorViewModel extends BaseViewModel{
  ...
  List<Tutor> _tutorsList = [
    Tutor(id: "1", name : "John", lastName: "Wick"),
    Tutor(id: "2", name : "John", lastName: "Wick"),
    Tutor(id: "3", name : "John", lastName: "Wick"),
    Tutor(id: "4", name : "John", lastName: "Wick"),
    Tutor(id: "5", name : "John", lastName: "Wick"),
  ];
